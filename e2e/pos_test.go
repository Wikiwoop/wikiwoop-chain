...
import (
	...
	"github.com/Wikiwoop/wikiwoop-chain/contracts/staking"
	"github.com/Wikiwoop/wikiwoop-chain/crypto"
	"github.com/Wikiwoop/wikiwoop-chain/e2e/framework"
	stakingHelper "github.com/Wikiwoop/wikiwoop-chain/helper/staking"
	"github.com/Wikiwoop/wikiwoop-chain/helper/tests"
	txpoolOp "github.com/Wikiwoop/wikiwoop-chain/txpool/proto"
	...
	ibftManager := framework.NewIBFTServersManager(
		...
		func(i int, config *framework.TestServerConfig) {
			if i < numGenesisValidators {
				...
				dirPrefix := "wikiwoop-chain-non-validator-"
